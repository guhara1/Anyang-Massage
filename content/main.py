...
{{
  ...
  "@type": "WebPage",
  "name": "안양 출장마사지·안양시 홈타이 지역별 예약 안내",
  "url": "{BASE_URL}/",
  "description": "안양 출장마사지·홈타이 예약 전 만안구, 동안구, 역세권, 이용 기준을 정리한 안내 페이지",
  "inLanguage": "ko-KR",
...
{{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [
    {{ "@type": "ListItem", "position": 1, "name": "안양 출장마사지·홈타이", "item": "{BASE_URL}/" }}
  ]
}}
</script>
<script type="application/ld+json">
{{
  ...
  "telephone": "{PHONE}",
  "description": "경기도 안양시 전지역(만안구·동안구) 방문 출장마사지·홈타이 예약 안내",
...
{{
  ...
  "mainEntity": [
    {{
      "@type": "Question",
      "name": "안양시 전지역 방문이 가능한가요?",
      "acceptedAnswer": {{ "@type": "Answer", "text": "예약 시간, 정확한 위치, 배정 상황에 따라 가능 여부가 달라집니다. 만안구와 동안구 전지역을 대상으로 안내하며, 대표 행정동과 역세권 페이지에서 본인 위치에 맞는 기준을 확인하실 수 있습니다." }}
    }},
    {{
      "@type": "Question",
      "name": "만안구와 동안구는 무엇이 다른가요?",
      "acceptedAnswer": {{ "@type": "Answer", "text": "만안구는 안양역·관악역·석수역·명학역을 중심으로 한 오래된 상권과 주거지가, 동안구는 범계역·평촌역·인덕원역을 중심으로 상권·업무지구·학원가가 함께 있는 지역입니다. 행정구 페이지에서 생활권 차이를 정리했습니다." }}
    }},
    {{
      "@type": "Question",
      "name": "안양1동~9동, 호계1·2·3동은 왜 따로 없나요?",
      "acceptedAnswer": {{ "@type": "Answer", "text": "번호로 나뉜 행정동은 안양동·호계동처럼 대표 행정동 페이지에서 통합 안내하여 비슷한 내용을 반복하는 중복 페이지 위험을 줄입니다. 예약은 주소 기준으로 진행됩니다." }}
    }},
    {{
      "@type": "Question",
      "name": "인덕원역은 노선이 여러 개인데 페이지가 하나인가요?",
      "acceptedAnswer": {{ "@type": "Answer", "text": "인덕원역은 향후 광역철도 계획이 있어도 인덕원역 안내 페이지 한 곳으로만 운영하고, 교통 특징은 본문에서 함께 설명합니다. 노선별로 페이지를 나누지 않습니다." }}
    }},
    {{
      "@type": "Question",
...
<ul class="card-grid">
<li><a href="/anyang/manan-gu-chuljangmassage/">만안구 출장마사지</a></li>
<li><a href="/anyang/dongan-gu-chuljangmassage/">동안구 출장마사지</a></li>
</ul>
</section>
...
<ul class="card-grid">
<li><a href="/anyang/manan/anyang-dong-chuljangmassage/">안양동</a></li>
<li><a href="/anyang/manan/seoksu-dong-chuljangmassage/">석수동</a></li>
<li><a href="/anyang/manan/chunghun-dong-chuljangmassage/">충훈동</a></li>
<li><a href="/anyang/manan/bakdal-dong-chuljangmassage/">박달동</a></li>
<li><a href="/anyang/manan/hohyeon-dong-chuljangmassage/">호현동</a></li>
</ul>
<p class="group-label">동안구</p>
<ul class="card-grid">
<li><a href="/anyang/dongan/bisan-dong-chuljangmassage/">비산동</a></li>
<li><a href="/anyang/dongan/buheung-dong-chuljangmassage/">부흥동</a></li>
<li><a href="/anyang/dongan/daran-dong-chuljangmassage/">달안동</a></li>
<li><a href="/anyang/dongan/gwanyang-dong-chuljangmassage/">관양동</a></li>
<li><a href="/anyang/dongan/indeogwon-dong-chuljangmassage/">인덕원동</a></li>
<li><a href="/anyang/dongan/burim-dong-chuljangmassage/">부림동</a></li>
<li><a href="/anyang/dongan/pyeongchon-dong-chuljangmassage/">평촌동</a></li>
<li><a href="/anyang/dongan/pyeongan-dong-chuljangmassage/">평안동</a></li>
<li><a href="/anyang/dongan/gwiin-dong-chuljangmassage/">귀인동</a></li>
<li><a href="/anyang/dongan/hogye-dong-chuljangmassage/">호계동</a></li>
<li><a href="/anyang/dongan/beomgye-dong-chuljangmassage/">범계동</a></li>
<li><a href="/anyang/dongan/sinchon-dong-chuljangmassage/">신촌동</a></li>
<li><a href="/anyang/dongan/galsan-dong-chuljangmassage/">갈산동</a></li>
</ul>
</section>
...
<ul class="card-grid">
<li><a href="/anyang/seoksu-station-chuljangmassage/">석수역</a></li>
<li><a href="/anyang/gwanak-station-chuljangmassage/">관악역</a></li>
<li><a href="/anyang/anyang-station-chuljangmassage/">안양역</a></li>
<li><a href="/anyang/myeonghak-station-chuljangmassage/">명학역</a></li>
<li><a href="/anyang/indeogwon-station-chuljangmassage/">인덕원역</a></li>
<li><a href="/anyang/pyeongchon-station-chuljangmassage/">평촌역</a></li>
<li><a href="/anyang/beomgye-station-chuljangmassage/">범계역</a></li>
</ul>
</section>
